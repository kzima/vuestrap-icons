...
/***/ function(module, exports, __webpack_require__) {
	...
	var _packageJson = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _introduction = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _introductionHtml = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iconsHtml = __webpack_require__(60);

	var _iconsHtml2 = _interopRequireDefault(_iconsHtml);

	var _iconsJson = __webpack_require__(61);
	...
	var _srcComponentsIcons = __webpack_require__(65);
...
/***/ function(module, exports) {
	...
	module.exports = "<!-- demo component -->\r\n<demo :meta=\"meta\" :snippet=\"snippet\" v-if=\"controls\">\r\n\t<!-- Html controls start-->\r\n\t<div slot=\"controls\" v-if=\"controls\">\r\n\t\t<label>\r\n\t\t\tsize\r\n\t\t\t<select v-model=\"controls.size\">\r\n\t\t\t\t<option v-for=\"option in controls.sizes\" v-bind:value=\"option.value\">\r\n\t\t\t    {{ option.text }}\r\n\t\t\t  </option>\r\n\t\t\t</select>\r\n\t\t</label>\r\n\r\n\t\t<label>\r\n\t\t\tvariant\r\n\t\t\t<select v-model=\"controls.variant\">\r\n\t\t\t\t<option v-for=\"option in controls.variants\" v-bind:value=\"option.value\">\r\n\t\t\t    {{ option.text }}\r\n\t\t\t  </option>\r\n\t\t\t</select>\r\n\t\t</label>\r\n\t</div>\r\n\t<!-- Html controls end-->\r\n\t\r\n\t<!-- Html markup start-->\r\n\t<div slot=\"markup\" v-bind:class=\"{ inverse: controls.variant === 'light' }\">\r\n\t\t<vs-icon name=\"info\" :size=\"controls.size\" :variant=\"controls.variant\"></vs-icon>\r\n\t\t<vs-icon name=\"info\" background=\"circle-outline\" :size=\"controls.size\" :variant=\"controls.variant\"></vs-icon>\r\n\t\t<vs-icon name=\"info\" background=\"circle-fill\" :size=\"controls.size\" :variant=\"controls.variant\"></vs-icon>\r\n\t\t<vs-icon background=\"circle-fill\" :size=\"controls.size\" :variant=\"controls.variant\" text=\"1\"></vs-icon>\r\n\t\t<vs-icon background=\"circle-outline\" :size=\"controls.size\" :variant=\"controls.variant\" text=\"1\"></vs-icon>\r\n\t\t<vs-icon background=\"circle-outline\" :size=\"controls.size\" :variant=\"controls.variant\" text=\"2\"></vs-icon>\r\n\t\t<vs-icon background=\"circle-outline\" :size=\"controls.size\" :variant=\"controls.variant\" text=\"11\"></vs-icon>\r\n\t\t<button class=\"btn btn-md\" aria-label=\"settings\"><vs-icon name=\"cog\" :size=\"'md'\" :variant=\"controls.variant\"></vs-icon> </button>\r\n\t\t<button class=\"btn btn-md\"><vs-icon name=\"cog\" :size=\"'md'\" :variant=\"controls.variant\"></vs-icon> settings</button>\r\n\t</div>\r\n\t<!-- Html markup end-->\r\n</demo>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iconsHtml = __webpack_require__(68);
